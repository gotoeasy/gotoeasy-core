...
public class JsConfig implements JsConfigKeys {
    ...
    public void anonymousClass(Object anonymous) {
        ...
        map.keySet().forEach(key -> classNameMap.put(key, (String)map.get(key)));
    }
    ...
    public void addBeans(Object obj) {
        ...
        map.keySet().forEach(name -> {
            if ( beans.containsKey(name) ) {
                ...
                throw new CoreException("Bean名称[" + name + "]重复");
            }

            Map<String, Object> bean = (Map<String, Object>)map.get(name);
            editClassName(bean);
    ...
    public void addProperties(Object obj) {
        ...
        for ( String name : map.keySet() ) {
            if ( values.containsKey(name) ) {
                ...
                throw new CoreException("属性名称[" + name + "]重复");
            }
        }
        values.putAll(map);
    ...
    private List toList(Object jsObj) {
        ...
        try {
            ...
            Object vals = valuesMethod.invoke(jsObj);
